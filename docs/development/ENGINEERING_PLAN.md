...
| `ENG-011` | `AUTHORIZED / REPAIR 5 DISPATCHED` | [ENG-011 Observability and Failure/Recovery Hardening Delivery Record](delivery/ENG-011-observability-failure-recovery-hardening.md) |
...
| [`ENG-011 — Observability and Failure/Recovery Hardening`](tasks/ENG-011-observability-failure-recovery-hardening.md) | 2 | `AUTHORIZED / REPAIR 5 DISPATCHED` | Repair-4 candidate frozen; findings R4-CONTROLLER-R001 through R004 accepted and bound to Repair 5 under unchanged nineteen-path lock; Formal DoR revision 2 PASS; READY YES; Current Builder ENG-011 REPAIR 5 BUILDER; implementation NOT YET STARTED; Human Reserved NOT REQUIRED; NO MIGRATION. |
