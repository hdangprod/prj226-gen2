...
| `ENG-011` | `READY / DISPATCHED / NOT YET IMPLEMENTED` | [ENG-011 Observability and Failure/Recovery Hardening Delivery Record](delivery/ENG-011-observability-failure-recovery-hardening.md) |
...
| [`ENG-011 — Observability and Failure/Recovery Hardening`](tasks/ENG-011-observability-failure-recovery-hardening.md) | 1 | `READY / DISPATCHED / NOT YET IMPLEMENTED` | Formal DoR revision 1 PASS; exact 12-path lock; Human Reserved NOT REQUIRED; NO MIGRATION; durable Controller Builder dispatch recorded. |
...
- `ENG-011` has one active exclusive writer, `ENG-011 BUILDER`, bounded to the exact 12 paths in Task Packet revision 1. The separate durable Controller dispatch is recorded; implementation is not yet started.
