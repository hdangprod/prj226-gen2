...
No task is `RUNNING`. `ENG-001`, `ENG-002`, `ENG-003`, `ENG-004`, and `ENG-008` are `DONE`. ENG-003 revision 2 is accepted on aggregate `183d97eeb8f1f1d9a718d40ceba03071c79432132ae9febeb851ed163301a685`; its revision-1 aggregate remains historical accepted evidence. ENG-004 is accepted on aggregate `6be8bc2b4d58cd1a0e9be7ea6a3762dafee0aa5a26796bb8e97214e48c1725c2` after controlled path-scoped manifestation, final deterministic PASS, and full review GREEN; its F001/F002/F003/F003-R1 history remains durable. `ENG-005` is `READY_FOR_BASELINE_RECONCILIATION`: it has no Knowledge-semantic finding, but its stated historical eight-file candidate is absent from available branch/tree and unreachable-blob surfaces, so recovery classification must precede reconciliation/rebase, a new manifest, integrated evidence, and review-validity disposition. `ENG-009` remains `PROPOSED` because it has no Task Packet or task-level Definition of Ready re-evaluation. All other nodes remain `PROPOSED` pending their listed predecessors and a complete Ready Task Packet.
...
| [`ENG-005 — Knowledge/provenance slice`](tasks/ENG-005-knowledge-provenance-slice.md) | 1 | `READY_FOR_BASELINE_RECONCILIATION` | First classify recovery of the historical candidate, then reconcile/rebase and re-manifest it against the accepted ENG-003/ENG-004 baseline; re-run integrated verification and determine review validity. |
...
- ENG-003 revision-2 persistence writing and ENG-004 closure are complete. ENG-005 must classify recovery of its historical candidate, then reconcile its candidate and evidence before any parallel-safe disposition is reconsidered.
