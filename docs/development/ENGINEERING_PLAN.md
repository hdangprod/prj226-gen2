...
| `ENG-011` | Complete data-minimized correlated observability and cross-layer failure/recovery hardening. Depends on `ENG-003` through `ENG-010`. | `AUTHORIZED / REPAIR 6 DISPATCHED` — [Task Packet revision 2](tasks/ENG-011-observability-failure-recovery-hardening.md); [Formal DoR revision 2 PASS](analysis/ENG-011_FORMAL_DoR_REV2_2026-08-28.md); Repair-5 Restart-1 candidate frozen after three accepted blocking findings; READY `YES`; Current Builder `ENG-011 REPAIR 6 BUILDER`; implementation `NOT YET STARTED`; Human Reserved `NOT REQUIRED`; `NO MIGRATION` | HIGH security/operability risk; exact nineteen-path lock and fresh full independent security/operability review remain required after candidate production | `ENG-011-TC-01` through `TC-21`, `R3-TC-01` through `R3-TC-18`, and Repair-6 findings `ENG-011-R5R1-DV-R001` through `R003`; full ENG-004–ENG-010 regressions; redaction, failure injection, path, dependency, architecture, and migration-identity evidence |
...
| `ENG-011` | `AUTHORIZED / REPAIR 6 DISPATCHED` | [ENG-011 Observability and Failure/Recovery Hardening Delivery Record](delivery/ENG-011-observability-failure-recovery-hardening.md) |
...
| [`ENG-011 — Observability and Failure/Recovery Hardening`](tasks/ENG-011-observability-failure-recovery-hardening.md) | 2 | `AUTHORIZED / REPAIR 6 DISPATCHED` | Repair-5 Restart-1 candidate frozen; findings `ENG-011-R5R1-DV-R001` through `R003` accepted and bound to Repair 6 under the unchanged nineteen-path lock; Formal DoR revision 2 PASS; READY YES; Current Builder ENG-011 REPAIR 6 BUILDER; implementation NOT YET STARTED; Human Reserved NOT REQUIRED; NO MIGRATION. |
