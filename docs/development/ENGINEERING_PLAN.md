...
| `ENG-007` | Deliver authoritative export and clear-scope, separately confirmed deletion with visible partial-failure/retry behavior. Depends on `ENG-003` through `ENG-006` as applicable. | `PROPOSED / PREPARED FOR FORMAL DoR RECHECK` — predecessors DONE; Planning Revision 1 `FROZEN / UNACCEPTED / FAILED FORMAL DoR / HISTORICAL`; failed Planning Revision 2 candidate `2acc99a5e75ba58ea4df53d6705ae5d44fe5bad8` `FROZEN / UNACCEPTED / FAILED FORMAL DoR REVISION 2 / HISTORICAL`; [Planning Revision 2 fresh repair successor](tasks/ENG-007-export-confirmed-deletion.md) `PREPARED FOR FORMAL DoR RECHECK`; Human Reserved decisions `HR-EXPORT-001`, `HR-EXPORT-002`, `HR-DELETE-001` through `HR-DELETE-004`, and `ENG-007-DOR-R003` are `RESOLVED`; `ENG-007-DOR2-R001` is `ACCEPTED / NARROW PLANNING REPAIR APPLIED`; Formal DoR is `NOT YET RUN`; `READY: NO`; Builder `NONE`; implementation `NOT STARTED` | HIGH destructive/data-control risk; fresh independent review required | Export-authority equality; no delete before confirmation; injected failure no-change/no-false-success; post-delete retrieval; duplicate/retry and provenance-chain tests |
...
- `ENG-006` Repair Rev1 is accepted and `ENG-006` is `DONE`; no ENG-006 Builder authority remains active. `ENG-007` Planning Revision 1, failed Planning Revision 2 candidate `2acc99a5e75ba58ea4df53d6705ae5d44fe5bad8`, and failed Implementation Candidate `e73bcd19d5ec9b4f2f939abcb8a4c807691198b7` remain `FROZEN / UNACCEPTED / HISTORICAL`; Planning Revision 3 fresh repair successor is `PROPOSED / PREPARED FOR NARROW INDEPENDENT DoR RECHECK (REPAIR 1)`; `ENG-007-DV-R001` repair is applied; `ENG-007-DV-R002` is dispositioned; Human Reserved decisions are resolved; Formal DoR recheck is `NOT YET RUN`; Builder is `NONE`; implementation is `BLOCKED PENDING REPAIRED READY AUTHORITY`.
