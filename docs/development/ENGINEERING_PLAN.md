...
| `ENG-007` | Deliver authoritative export and clear-scope, separately confirmed deletion with visible partial-failure/retry behavior. Depends on `ENG-003` through `ENG-006` as applicable. | `READY / DISPATCHED TO BUILDER REPAIR 5` — predecessors DONE; Planning Revision 1 `FROZEN / UNACCEPTED / FAILED FORMAL DoR / HISTORICAL`; failed Planning Revision 2 candidate `2acc99a5e75ba58ea4df53d6705ae5d44fe5bad8` `FROZEN / UNACCEPTED / FAILED FORMAL DoR REVISION 2 / HISTORICAL`; [Planning Revision 3 Task Packet](tasks/ENG-007-export-confirmed-deletion.md) `ACCEPTED / READY AUTHORITY` after independent Formal DoR recheck `PASS`; [ENG-007 Delivery Record](delivery/ENG-007-export-confirmed-deletion.md) `ACTIVE`; failed implementation candidates `e73bcd19d5ec9b4f2f939abcb8a4c807691198b7`, `b55d29cb77ae6acd2a8da37406aa47993c0d01e2`, `514c68e5eaf4f140e1b978a7160c5c7a16343a9d`, `4bb8347bd92a1533770b4c04de8c2738f7fcd20c` (tree `05cae77cd08d56231f096c243686cdf824f76d84`), and `f12647374bef083b01b7289f823faa7d8625c733` (tree `907a934e9e5e5fb2727530ce6b07b83d8184a37e`) `FROZEN / UNACCEPTED / HISTORICAL ONLY`; `ENG-007-SR-R001` is `CLOSED`; `ENG-007-SR-R003` is `CLOSED`; `ENG-007-SR-R002` is `OPEN` (`ENG-007-SR-R002-R1` `ACCEPTED / BLOCKING / ASSIGNED TO BUILDER REPAIR 5`); `READY: YES`; Builder `ENG-007 BUILDER REPAIR 5`; dispatch `AUTHORIZED / DURABLY RECORDED`; implementation `NOT YET STARTED` | HIGH destructive/data-control risk; fresh independent review required | Export-authority equality; no delete before confirmation; injected failure no-change/no-false-success; post-delete retrieval; duplicate/retry and provenance-chain tests |
...
- `ENG-006` Repair Rev1 is accepted and `ENG-006` is `DONE`; no ENG-006 Builder authority remains active. `ENG-007` Planning Revision 1, failed Planning Revision 2 candidate `2acc99a5e75ba58ea4df53d6705ae5d44fe5bad8`, and failed implementation candidates `e73bcd19d5ec9b4f2f939abcb8a4c807691198b7`, `b55d29cb77ae6acd2a8da37406aa47993c0d01e2`, `514c68e5eaf4f140e1b978a7160c5c7a16343a9d`, `4bb8347bd92a1533770b4c04de8c2738f7fcd20c` (tree `05cae77cd08d56231f096c243686cdf824f76d84`), and `f12647374bef083b01b7289f823faa7d8625c733` (tree `907a934e9e5e5fb2727530ce6b07b83d8184a37e`) remain `FROZEN / UNACCEPTED / HISTORICAL ONLY`; [Planning Revision 3 Task Packet](tasks/ENG-007-export-confirmed-deletion.md) is `READY / DURABLY RECORDED` after independent Formal DoR recheck `PASS`; [ENG-007 Delivery Record](delivery/ENG-007-export-confirmed-deletion.md) is `ACTIVE`; `ENG-007-SR-R001` is `CLOSED`; `ENG-007-SR-R003` is `CLOSED`; `ENG-007-SR-R002` is `OPEN` (`ENG-007-SR-R002-R1` assigned to Builder Repair 5); Builder is `ENG-007 BUILDER REPAIR 5`; dispatch is `AUTHORIZED / DURABLY RECORDED`; implementation is `NOT YET STARTED`.
...
- **Current task state:** no task is `RUNNING`. `ENG-003` revision 3 is `ACCEPTED` and `ENG-003` is `DONE` on candidate `5276481824e43d23345799c39efaa72e51235877`, tree `0ea10d0400a5439af60c72ce943b7504e4173674`, and aggregate `a5bb90a62af050b2cc7bcf1beecac072b3927b45d91178e65564935d7420c156`; its prior accepted history remains durable. `ENG-004` and `ENG-005` remain `DONE`. `ENG-006` Repair Rev1 is `ACCEPTED` on candidate `a94d2cd2714849e7be59fd464f85330f98d127b4`, tree `6d4a20cb745b811724a8837e495ab3a19c32285b`, and aggregate `5427769010520ef1c992d201e42b341204c621a3d4ed7f84ce60eae71adcccda`; governance closure and canonical integration are `2bdad043dce96d906a331f2ab7ae42d1ea590068`, and ENG-006 is `DONE / POST-INTEGRATION VERIFIED`; `R001`–`R003` are closed, `R004` remains closed at upstream ENG-003 level, and `R005` remains deferred to `ENG-010`. Failed candidate `7b7db0d98660f6562f8e9738445be725fc65988c` remains `FROZEN / UNACCEPTED`. Current Builder is `NONE`. ENG-009 Revision 1 is frozen historical evidence; Revision 2 independently passed Formal DoR; independent post-integration verification reported `PASS` for immutable READY base `b4e8b34ecd66372f07e02e9f4a2c61b4cbf310f3`; and ENG-009 is `READY / CANONICALIZED / POST-INTEGRATION VERIFIED / NOT DISPATCHED`. ENG-007 Planning Revision 1 `d7a6c0cf9d824e5f65e1eb5cc30144a063249fe4` and failed Planning Revision 2 candidate `2acc99a5e75ba58ea4df53d6705ae5d44fe5bad8` remain `FROZEN / UNACCEPTED / HISTORICAL`; failed implementation candidates `e73bcd19d5ec9b4f2f939abcb8a4c807691198b7`, `b55d29cb77ae6acd2a8da37406aa47993c0d01e2`, `514c68e5eaf4f140e1b978a7160c5c7a16343a9d`, `4bb8347bd92a1533770b4c04de8c2738f7fcd20c` (tree `05cae77cd08d56231f096c243686cdf824f76d84`), and `f12647374bef083b01b7289f823faa7d8625c733` (tree `907a934e9e5e5fb2727530ce6b07b83d8184a37e`) remain `FROZEN / UNACCEPTED / HISTORICAL ONLY`; [Planning Revision 3 Task Packet](tasks/ENG-007-export-confirmed-deletion.md) is `READY / DURABLY RECORDED` after independent Formal DoR recheck `PASS`; [ENG-007 Delivery Record](delivery/ENG-007-export-confirmed-deletion.md) is `ACTIVE`; Human Reserved decisions `HR-EXPORT-001`, `HR-EXPORT-002`, `HR-DELETE-001` through `HR-DELETE-004`, and `ENG-007-DOR-R003` are `RESOLVED`; `ENG-007-DV-R001` is `CLOSED BY REVISION 3 DoR RECHECK`; `ENG-007-DV-R002` is `DISPOSITIONED`; `ENG-007-SR-R001` is `CLOSED`; `ENG-007-SR-R003` is `CLOSED`; `ENG-007-SR-R002` is `OPEN` (`ENG-007-SR-R002-R1` `ACCEPTED / BLOCKING / ASSIGNED TO BUILDER REPAIR 5`); `READY: YES`; Builder `ENG-007 BUILDER REPAIR 5`; Builder dispatch `AUTHORIZED / DURABLY RECORDED`; implementation `NOT YET STARTED`. Later tasks retain their declared dependencies.
