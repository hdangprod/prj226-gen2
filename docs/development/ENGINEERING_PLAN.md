...
ENG-001 Runtime/tooling foundation
  -> ENG-002 Domain/application kernel
       -> ENG-003 D1 authority foundation (DONE on accepted revision-2 lifecycle-transition baseline)
            ...
            -> ENG-005 Knowledge/provenance slice (VERIFICATION PENDING) -------------+-> ENG-006 Direct-SQL retrieval/resumption
...
No task is `RUNNING`. `ENG-001`, `ENG-002`, `ENG-003`, `ENG-004`, and `ENG-008` are `DONE`. ENG-003 revision 2 is accepted on aggregate `183d97eeb8f1f1d9a718d40ceba03071c79432132ae9febeb851ed163301a685`; its revision-1 aggregate remains historical accepted evidence. ENG-004 is accepted on aggregate `6be8bc2b4d58cd1a0e9be7ea6a3762dafee0aa5a26796bb8e97214e48c1725c2` after controlled path-scoped manifestation, final deterministic PASS, and full review GREEN; its F001/F002/F003/F003-R1 history remains durable. `ENG-005` is `VERIFICATION PENDING — VERIFICATION_CONTRACT_RECONCILED` for candidate `1d58b114ceaeed370e5f2fb8084660f7bd106385`: its exact-target service boundary cannot represent an ambiguous correction target, so its revised verification contract requires malformed/missing exact-target evidence and preserves ambiguous-target clarification for upstream `ENG-010` orchestration. A fresh full deterministic run and then fresh full independent review remain required. `ENG-009` remains `PROPOSED` because it has no Task Packet or task-level Definition of Ready re-evaluation. All other nodes remain `PROPOSED` pending their listed predecessors and a complete Ready Task Packet.
...
| [`ENG-005 — Knowledge/provenance slice`](tasks/ENG-005-knowledge-provenance-slice.md) | 2 | `VERIFICATION PENDING — VERIFICATION_CONTRACT_RECONCILED` | Current exact-target candidate requires fresh full deterministic verification under the corrected evidence applicability, then fresh full independent review. |
...
`ENG-005: VERIFICATION PENDING — VERIFICATION_CONTRACT_RECONCILED — NO SEMANTIC REPAIR`
...
- ENG-003 revision-2 persistence writing and ENG-004 closure are complete. ENG-005 historical bytes are irrecoverable; its current exact-target candidate is awaiting fresh full verification under the reconciled contract, then fresh independent review. Ambiguous-target clarification remains an upstream ENG-010 responsibility.
...
- **Current task state:** no task is `RUNNING`. `ENG-003` revision 2 is `DONE` on accepted aggregate `183d97eeb8f1f1d9a718d40ceba03071c79432132ae9febeb851ed163301a685`; its revision-1 exact candidate and closed finding history remain durable. `ENG-004` is `DONE` on accepted aggregate `6be8bc2b4d58cd1a0e9be7ea6a3762dafee0aa5a26796bb8e97214e48c1725c2`, with F001/F002/F003/F003-R1 closed and recovery provenance retained. `ENG-005` is `VERIFICATION PENDING — VERIFICATION_CONTRACT_RECONCILED` under Task Packet revision 2; current candidate `1d58b114ceaeed370e5f2fb8084660f7bd106385` is not accepted, and full verification must run again under its exact-target contract. `ENG-009` remains `PROPOSED` until its separate Task Packet and DoR exist. Later tasks retain their declared dependencies.
