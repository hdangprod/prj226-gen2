...
| [`ENG-004 — Project/Action/context slice`](tasks/ENG-004-project-action-context-slice.md) | 2 | `READY_FOR_BOUNDED_REPAIR` | Start from recovery commit `f8e7d6a08361a88a7f146b76e1599bb4daa71150` (`recovery/eng-004-historical-a795e4a`) composed over ENG-003 rev2, then dispatch only the existing three-root bounded repair and require fresh verification plus fresh full review. |
