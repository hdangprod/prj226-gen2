...
| `ENG-011` | Complete data-minimized correlated observability and cross-layer failure/recovery hardening. Depends on `ENG-003` through `ENG-010`. | `VERIFICATION PENDING / REPAIR 6 ATTEMPT 2 REDISPATCHED` — candidate `dce0f5babc9156383620ba8511f074197995b6a6`, tree `6f13a3c8278b62184476c2cae73f7239c2a4ceff`; Attempt 1 blocked before verification on `ENG-011-R6-DV-ENV-F001`; Attempt 2 startup PASS; Current Builder `NONE`; Human Reserved `NOT REQUIRED`; `NO MIGRATION` ([Controller Disposition](analysis/ENG-011_REPAIR6_VERIFIER_ISOLATION_COLLISION_DISPOSITION_2026-08-29.md)) | HIGH security/operability risk; exact nineteen-path lock and fresh full independent security/operability review remain required after deterministic PASS | `ENG-011-TC-01` through `TC-21`, `R3-TC-01` through `R3-TC-18`, and Repair-6 findings `ENG-011-R5R1-DV-R001` through `R003`; full ENG-004–ENG-010 regressions; redaction, failure injection, path, dependency, architecture, and migration-identity evidence |
...
| `ENG-011` | `VERIFICATION PENDING / REPAIR 6 ATTEMPT 2 REDISPATCHED` | [ENG-011 Observability and Failure/Recovery Hardening Delivery Record](delivery/ENG-011-observability-failure-recovery-hardening.md) |
...
| [`ENG-011 — Observability and Failure/Recovery Hardening`](tasks/ENG-011-observability-failure-recovery-hardening.md) | 2 | `VERIFICATION PENDING / REPAIR 6 ATTEMPT 2 REDISPATCHED` | Candidate `dce0f5babc9156383620ba8511f074197995b6a6` is immutable, unaccepted, and non-canonical; Attempt 1 stopped before verification on `ENG-011-R6-DV-ENV-F001`; Attempt 2 startup PASS; Current Builder NONE; Formal DoR revision 2 PASS; Human Reserved NOT REQUIRED; NO MIGRATION. |
...
- `ENG-011` Repair-6 candidate `dce0f5babc9156383620ba8511f074197995b6a6` is immutable, unaccepted, non-canonical, and awaiting fresh deterministic verification. Verifier Attempt 1 is blocked, complete, and non-operative after environment finding `ENG-011-R6-DV-ENV-F001`; Attempt 2 is provisioned with startup `PASS`. Formal DoR revision 2 remains `PASS`; READY is `YES`; Current Builder is `NONE`.
...
- **Current task state:** no implementation task is `RUNNING`; `ENG-001` through `ENG-010` are `DONE`. ENG-011 Task Packet revision 2 is `OPERATIVE`; Formal DoR revision 2 is `PASS`; Repair-6 candidate `dce0f5babc9156383620ba8511f074197995b6a6` is immutable, unaccepted, non-canonical, and awaiting deterministic verification; Attempt 2 is provisioned with startup `PASS`; Current Builder is `NONE`. Later tasks retain their declared dependencies.
