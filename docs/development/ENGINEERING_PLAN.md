...
No implementation task is `RUNNING`. `ENG-001` through `ENG-010` retain their accepted `DONE` identities and closure evidence. `ENG-010` remains `DONE / ACCEPTED / CANONICALIZED / POST-INTEGRATION VERIFIED / GOVERNANCE-CLOSED`. ENG-011 Repair-4 candidate `5f3d0d22a2cb54850ef9c3fe99137237a4e905e3` is frozen, unaccepted, historical, and non-canonical after four accepted blocking deterministic findings (`R4-CONTROLLER-R001` through `R004`). Task Packet revision 2 remains `OPERATIVE` with its nineteen-path write lock; Formal DoR revision 2 is `PASS`; READY is `YES`; original Repair-5 dispatch (`0af56e186b44396f524183125e5d053ea41e876e`) and Builder are superseded; Repair 5 Restart-1 is `AUTHORIZED / DURABLY DISPATCHED`; Current Builder is `ENG-011 REPAIR 5 BUILDER RESTART-1`; implementation is `NOT YET STARTED`. Human Reserved remains `NOT REQUIRED`; migration remains `NO MIGRATION`.
...
| `ENG-011` | Complete data-minimized correlated observability and cross-layer failure/recovery hardening. Depends on `ENG-003` through `ENG-010`. | `AUTHORIZED / REPAIR 5 DISPATCHED (RESTART-1)` — [Task Packet revision 2](tasks/ENG-011-observability-failure-recovery-hardening.md); [Formal DoR revision 2 PASS](analysis/ENG-011_FORMAL_DoR_REV2_2026-08-28.md); Repair-4 candidate frozen; READY `YES`; Current Builder `ENG-011 REPAIR 5 BUILDER RESTART-1`; implementation `NOT YET STARTED`; Human Reserved `NOT REQUIRED`; `NO MIGRATION` | HIGH security/operability risk; exact nineteen-path lock and fresh full independent security/operability review remain required after candidate production | `ENG-011-TC-01` through `TC-21`, `R3-TC-01` through `R3-TC-18`; full ENG-004–ENG-010 regressions; redaction, failure injection, path, dependency, architecture, and migration-identity evidence |
...
| `ENG-011` | `AUTHORIZED / REPAIR 5 DISPATCHED (RESTART-1)` | [ENG-011 Observability and Failure/Recovery Hardening Delivery Record](delivery/ENG-011-observability-failure-recovery-hardening.md) |
...
| [`ENG-011 — Observability and Failure/Recovery Hardening`](tasks/ENG-011-observability-failure-recovery-hardening.md) | 2 | `AUTHORIZED / REPAIR 5 DISPATCHED (RESTART-1)` | Repair-4 candidate frozen; findings R4-CONTROLLER-R001 through R004 accepted and bound to Repair 5 under unchanged nineteen-path lock; Formal DoR revision 2 PASS; READY YES; original Repair-5 Builder superseded; Current Builder ENG-011 REPAIR 5 BUILDER RESTART-1; implementation NOT YET STARTED; Human Reserved NOT REQUIRED; NO MIGRATION. |
...
- `ENG-011` Repair 3 is durably dispatched to `ENG-011 REPAIR 3 BUILDER` under Task Packet revision 2's exact nineteen-path lock on branch `eng-011-builder-repair-3`. Repair-2 candidate `49990f306ee67b62ae017f0d63fa556bde06d23a` is frozen after accepted R001-R009. Formal DoR revision 2 is `PASS`; READY is `YES`; implementation is `NOT YET STARTED`.
