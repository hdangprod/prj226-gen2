...
| `product/SCENARIOS.md` | NOT_CREATED | Future canonical scenario corpus and expected semantic outcomes | Reserved for C3; creation requires prior authorization. |
